...
![Current project in Amazon Sagemaker](../source/static/images/currentdata.png)
...
![image shows adding aurora mysql as a federated data source](../source/static/images/FSI-Images/Screenshot%202026-03-10%20at%207.37.38%E2%80%AFPM.png)
...
![Adding admins](../source/static/images/lf.png)
...
![image shows lake formation adding AWSServiceRoleForRedshift as a read only admin](../source/static/images/admins.png)
...
![image shows Lake Formation granting permissions to the catalog.](../source/static/images/grantp.png)
...
![image shows Lake Formation granting permissions to the catalog.](../source/static/images/permissionsoncatalog.png)



Your Lake Formation Data permissions should now look similar to the below screenshot.

![image shows Lake Formation final permissions on the catalog](../source/static/images/updated.png)
