...
![Amazon Quick Home](../source/static/images/FSI-Images/Lab6-Quick7.png)
...
![Amazon Quick Home](../source/static/images/FSI-Images/Lab6-Quick8.png)

3. Choose **Create dataset** as shown below

![Amazon Quick Home](../source/static/images/FSI-Images/Lab6-Quick9.png)

4. We will use the **Custom SQL** capability of Quick Suite for connecting to the source data:

![Amazon Quick Home](../source/static/images/FSI-Images/Lab6-Quick10.png)
...
![Add Custom SQL](../source/static/images/FSI-Images/Lab6-Quick-01-Add-Custom-SQL-RiskMetrics.png)

8. In the pop-up to **Finish dataset creation**, select **Directly query your data** and select **Visualize**.

![Add Custom SQL](../source/static/images/FSI-Images/Lab6-Quick-02-Select-Direct-Query.png)
...
![Select Visual](../source/static/images/FSI-Images/Lab6-Quick-04-Select-visual.png)
...
![Select average](../source/static/images/FSI-Images/Lab6-Quick-05-Select-average-marketriskscore.png)
...
![Show Visual](../source/static/images/FSI-Images/Lab6-Quick-06-Visual-created.png)
...
![Select create topic](../source/static/images/FSI-Images/Lab6-Quick-09-Select-create-topic.png)

16. In the screen for **New Topic**, for **Topic name** add :code[Risk_Metrics]{showCopyAction=true} and select **Apply changes**.

![Rename Topic](../source/static/images/FSI-Images/Lab6-Quick-11-Name-topic.png)
...
![Publish Dashboard](../source/static/images/FSI-Images/Lab6-Quick-13-Publish-Dashboard.png)
...
In the next 3 sections, we will use the following AI-powered natural language processing features to interact with and generate responses from the dataset:
  ...
  6.1 . [Perform Dashboard Q&A in Quick Sight](07-01-dashboard-qa.md)

  6.2. [Create and use Quick Suite Spaces with default chat agent](07-02-default-chat-agent.md)

  6.3. [Build a personalized Risk Assessment Chat agent](07-03-personalized-chat-agent.md) (Optional)
