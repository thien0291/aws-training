...
![Create Space](../source/static/images/FSI-Images/Lab6-Quick-17-Create-space.png)
...
![Name space and add knowledge](../source/static/images/FSI-Images/Lab6-Quick-18-Name-space.png)

3. Select **Add knowledge** and then choose **Dashboards**. Select `RiskMetrics_Dashboard` and then select **Add**.

![Add Dashboard](../source/static/images/FSI-Images/Lab6-Quick-19-Add-dashboard-to-space.png)

4. Next, select **Add knowledge** and then choose **Topics**. Select the `Risk_Metrics` topic and then select **Add**.

![Add Topic](../source/static/images/FSI-Images/Lab6-Quick-20-Add-Topics-to-space.png)

5. Once completed, you will be able to see the added dashboard and topic under **All knowledge** of the `Risk Assessment` space.

![Add Topic](../source/static/images/FSI-Images/Lab6-Quick-21-Space-view.png)
...
![Use space in chat](../source/static/images/FSI-Images/Lab6-Quick-22-Use-Space-in-chat.png)
...
![Default chat](../source/static/images/FSI-Images/Lab6-Quick-30-Default_chat.png)
