...
![rds console zero-etl integration tab](../source/static/images/Image44.png)
...
![zero-etl integration step1](../source/static/images/ztl_s1lakehouse.png)

3. Under Step 2: *Select source*, select **Browse RDS databases** and choose the source Aurora MySQL cluster named *zetlsagemaker*. 

![zero-etl integration step2 choose](../source/static/images/db.png)
...
![zero-etl integration wizard_datafilter](../source/static/images/ztl_s2checks.png)
...
![Target in Zero ETL Integration](../source/static/images/targ.png)

8. On the review pop-up that appears, choose **Continue**.

9. Under Step 4: *Add tags and encryption* (optional), choose **Next**.

![zero-etl integration step4](../source/static/images/ztl_s4.png)
...
![zero-etl integration progress](../source/static/images/Imagewait.png)
