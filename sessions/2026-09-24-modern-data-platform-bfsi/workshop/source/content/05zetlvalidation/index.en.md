...
::alert[**Common Issue - Permissions Error:** Many users encounter a permissions error when querying Zero-ETL tables. If you see `GENERIC_INTERNAL_ERROR: Forbidden` with `glue:GetTable`, follow the [Quick Fix Guide](../../static/LAB05_PERMISSIONS_QUICK_FIX.md) (5 minutes) or use the [automated CLI script](../../static/fix_glue_permissions_cli.sh). See the [detailed troubleshooting guide](../../TROUBLESHOOTING.md#lab-05-glue-permissions-error) for more information.]{type=warning}
...
![SageMaker Query Editor](/static/images/FSI-Images/Screenshot%202026-03-13%20at%203.46.06 PM.png)
...
![SageMaker Query Editor](/static/images/FSI-Images/Screenshot%202026-03-13%20at%203.35.58 PM.png)
...
::alert[**Troubleshooting Permissions Error:** If you receive a `GENERIC_INTERNAL_ERROR: Forbidden` error stating the user is not authorized to perform `glue:GetTable`, this means the DataZone user role needs additional Glue permissions. Follow the [Quick Fix Guide](../../static/LAB05_PERMISSIONS_QUICK_FIX.md) (takes 5 minutes) or use the [automated CLI script](../../static/fix_glue_permissions_cli.sh). See the [detailed fix guide](../../static/fix_glue_permissions.md) for step-by-step instructions with screenshots.]{type=warning}
...
```
![SageMaker Query result ](/static/images/FSI-Images/Screenshot%202026-03-13%20at%203.39.33 PM.png)
...
![image shows selecting EC2 instance and selecting the connect button](/static/images/FSI-Images/Screenshot%202026-03-13%20at%201.46.13 PM.png)

2. Select the option of Session manager and choose **Connect**.

![image shows Session Manager tab on the connection options for EC2](/static/images/FSI-Images/Screenshot%202026-03-13%20at%201.46.51 PM.png)
...
![image shows connecting to mysql within an EC2 instance](/static/images/FSI-Images/Screenshot%202026-03-13%20at%201.48.19 PM.png)
